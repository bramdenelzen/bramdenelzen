...
I am a Freelance Full Stack Developer and Informatics student at **Avans University**, blending technical precision with creative problem-solving. Transitioning from a background in **Studio Engineering**, I bring a disciplined, detail-oriented approach to software architecture and digital product building.

My focus lies in modern web ecosystems, leveraging tools like **Next.js**, **GSAP**, and **PayloadCMS** to create scalable, high-performance applications.
